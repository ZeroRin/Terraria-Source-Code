...
namespace Terraria.Social.WeGame
{
  public class NetClientSocialModule : NetSocialModule
  {
    ...
    private void AsyncSetMyMetaData(string key, string value) => rail_api.RailFactory().RailFriends().AsyncSetMyMetadata(new List<RailKeyValue>()
    {
    ...
    public override bool CanInvite() => (this._hasLocalHost || this._lobby.State == LobbyState.Active || Main.LobbyId != 0UL) && Main.netMode != 0;
    ...
    private void AsyncSetPlayWith(RailID rail_id) => rail_api.RailFactory().RailFriends()?.AsyncReportPlayedWithUserList(new List<RailUserPlayedWith>()
    {
