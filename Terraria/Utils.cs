...
namespace Terraria
{
  public static class Utils
  {
    ...
    public static float Turn01ToCyclic010(float value) => (float) (1.0 - (Math.Cos((double) value * 6.2831854820251465) * 0.5 + 0.5));
    ...
    public static float RandomFloat(ref ulong seed) => (float) Utils.RandomNext(ref seed, 24) / 16777216f;
