  ...
  public static class ItemFilters
  {
    ...
    public class BuildingBlock : IItemEntryFilter, IEntryFilter<Item>
    {
      ...
      public UIElement GetImage()
      {
        ...
        UIImageFramed image = new UIImageFramed(asset, asset.Frame(9, frameX: 4).OffsetSize(-2, 0));
        image.HAlign = 0.5f;
        image.VAlign = 0.5f;
        return (UIElement) image;
      }
    ...
    public class Weapon : IItemEntryFilter, IEntryFilter<Item>
    {
      ...
      {
        Asset<Texture2D> asset = Main.Assets.Request<Texture2D>("Images/UI/Creative/Infinite_Icons", (AssetRequestMode) 1);
        UIImageFramed image = new UIImageFramed(asset, asset.Frame(9).OffsetSize(-2, 0));
        image.HAlign = 0.5f;
        image.VAlign = 0.5f;
        return (UIElement) image;
      }
    ...
    public class Armor : IItemEntryFilter, IEntryFilter<Item>
    {
      ...
      {
        Asset<Texture2D> asset = Main.Assets.Request<Texture2D>("Images/UI/Creative/Infinite_Icons", (AssetRequestMode) 1);
        UIImageFramed image = new UIImageFramed(asset, asset.Frame(9, frameX: 2).OffsetSize(-2, 0));
        image.HAlign = 0.5f;
        image.VAlign = 0.5f;
        return (UIElement) image;
      }
    ...
    public class Accessories : IItemEntryFilter, IEntryFilter<Item>
    {
      ...
      {
        Asset<Texture2D> asset = Main.Assets.Request<Texture2D>("Images/UI/Creative/Infinite_Icons", (AssetRequestMode) 1);
        UIImageFramed image = new UIImageFramed(asset, asset.Frame(9, frameX: 1).OffsetSize(-2, 0));
        image.HAlign = 0.5f;
        image.VAlign = 0.5f;
        return (UIElement) image;
      }
    ...
    public class Consumables : IItemEntryFilter, IEntryFilter<Item>
    {
      ...
      {
        Asset<Texture2D> asset = Main.Assets.Request<Texture2D>("Images/UI/Creative/Infinite_Icons", (AssetRequestMode) 1);
        UIImageFramed image = new UIImageFramed(asset, asset.Frame(9, frameX: 3).OffsetSize(-2, 0));
        image.HAlign = 0.5f;
        image.VAlign = 0.5f;
        return (UIElement) image;
      }
    ...
    public class GameplayItems : IItemEntryFilter, IEntryFilter<Item>
    {
      ...
      {
        Asset<Texture2D> asset = Main.Assets.Request<Texture2D>("Images/UI/Creative/Infinite_Icons", (AssetRequestMode) 1);
        UIImageFramed image = new UIImageFramed(asset, asset.Frame(9, frameX: 5).OffsetSize(-2, 0));
        image.HAlign = 0.5f;
        image.VAlign = 0.5f;
        return (UIElement) image;
      }
    ...
    public class Materials : IItemEntryFilter, IEntryFilter<Item>
    {
      ...
      {
        Asset<Texture2D> asset = Main.Assets.Request<Texture2D>("Images/UI/Creative/Infinite_Icons", (AssetRequestMode) 1);
        UIImageFramed image = new UIImageFramed(asset, asset.Frame(9, frameX: 6).OffsetSize(-2, 0));
        image.HAlign = 0.5f;
        image.VAlign = 0.5f;
        return (UIElement) image;
      }
