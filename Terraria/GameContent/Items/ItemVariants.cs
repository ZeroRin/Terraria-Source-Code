...
namespace Terraria.GameContent.Items
{
  public static class ItemVariants
  {
    ...
    public static IEnumerable<ItemVariants.VariantEntry> GetVariants(int itemId) => !ItemVariants._variants.IndexInRange<List<ItemVariants.VariantEntry>>(itemId) ? Enumerable.Empty<ItemVariants.VariantEntry>() : (IEnumerable<ItemVariants.VariantEntry>) ItemVariants._variants[itemId] ?? Enumerable.Empty<ItemVariants.VariantEntry>();
