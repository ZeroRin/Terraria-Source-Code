...
namespace Terraria.GameContent.Biomes.CaveHouse
{
  public class MarbleHouseBuilder : HouseBuilder
  {
    ...
    protected override void AgeRoom(Microsoft.Xna.Framework.Rectangle room)
    {
      ...
      WorldUtils.Gen(new Point(room.X, room.Y), (GenShape) new Shapes.Rectangle(room.Width, room.Height), Actions.Chain((GenAction) new Modifiers.Dither(0.85000002384185791), (GenAction) new Modifiers.Blotches(), (GenAction) new Actions.PlaceWall((ushort) 178)));
    }
  }
}
