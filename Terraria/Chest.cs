...
namespace Terraria
{
  public class Chest
  {
    ...
    {
      bool flag1 = Main.LocalPlayer.currentShoppingSettings.PriceAdjustment <= 0.85000002384185791;
      ...
      switch (type)
      {
        ...
        case 23:
          ...
          if (!NPC.boughtBunny && (double) bestiaryProgressReport.CompletionPercent >= 0.44999998807907104)
          ...
          if ((double) bestiaryProgressReport.CompletionPercent >= 0.60000002384185791)
