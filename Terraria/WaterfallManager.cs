        ...
        for (int index5 = 0; index5 < num25; ++index5)
        {
          if (num24 < 2)
          {
            switch (index2)
            {
              case 1:
                double num26;
                float r1 = (float) (num26 = (0.550000011920929 + (double) (270 - (int) Main.mouseTextColor) / 900.0) * 0.40000000596046448);
                float g1 = (float) (num26 * 0.30000001192092896);
                float b1 = (float) (num26 * 0.10000000149011612);
